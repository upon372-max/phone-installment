  ...
  return (
    <div style={styles.formCard}>
      ...
      <form onSubmit={handleSubmit}>
        <input style={styles.input} name="full_name" placeholder="Full Name" value={form.full_name} onChange={handleChange} required />
        ...
        <button style={styles.button} type="submit">Add Customer</button>
      </form>
    </div>
  );
};
